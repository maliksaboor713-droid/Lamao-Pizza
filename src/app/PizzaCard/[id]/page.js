...
// import { pizzas } from "../../../dataLib/page";
...
export default async function product({params}) {
  ...
  const product = pizzas.find((product)=> product.id === Number(id));
  if (!product){
  ...
  return (
    ...
    <div className=" bg-orange-800 p-12 h-100vh w-full grid sm:grid-cols-1 lg:grid-cols-2 justify-center items-center gap-10 ">
          <Image className=" w-[80vh] h-[80vh] bg-blue-900 p-1 border rounded-[20px] " src={product.image} alt={product.name} width={500} height={500} />
