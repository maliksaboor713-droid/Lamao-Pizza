...
export default function Footer() {
  return (
    <>
    <footer>
      <div className="h-[clamp(auto,30vmin)] bg-blue-900 flex max-sm:flex-col md:flex-row justify-around items-center border-t-10 border-t-black">
    ...
    <p className='text-[1.2rem] font-(900)'>At Lama, we believe great pizza starts with honest ingredients. 
      ...
      <div className="h-12 bg-black text-white text-[1.2rem] text-center content-center border-t-6 border-t-gray-400">
